...
bfs_bulk.add_loop("bfs", 71, UNROLL_ONE)
...
gemm_blocked.add_loop("bbgemm", 46, UNROLL_ONE)
gemm_blocked.add_loop("bbgemm", 47, 64)
gemm_blocked.add_loop("bbgemm", 48, UNROLL_FLATTEN)
gemm_blocked.add_loop("bbgemm", 52, UNROLL_FLATTEN)
...
kmp_kmp.add_loop("CPF", 41, UNROLL_ONE)
kmp_kmp.add_loop("kmp", 60, 32411)
kmp_kmp.add_loop("kmp", 61, UNROLL_ONE)
...
md_grid.add_loop("md", 52, 1) #FIXME
...
nw_nw.add_loop("needwun", 55, UNROLL_FLATTEN)
